...
include("oauth/tokenStore/WpTokenStore.php");
...
class ScoopIt {
	...
	public function __construct($tokenStore, $consumerKey, $consumerSecret, $httpBackend = null, $scoopitServerUrl = null) {
	...
	public function getLoginUrl($callback){
		...
		return $this->scitAuthorizeUrl."?oauth_token=$requestToken&oauth_callback=".urlencode($callback);
	...
	public function topic($id, $curated=30, $curable=0, $page=0, $since = -1) {
		return $this->get($this->scitServer."api/1/topic?id=".$id."&order=curationDate&curated=".$curated."&curable=".$curable."&page=".$page."&since=".$since)->topic;
	}
